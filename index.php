...
<form class="form-horizontal">
    <fieldset>
        ...
        <!-- Select Basic -->
        <div class="form-group">
            <label class="col-md-4 control-label" for="tipo">Tipo de animal</label>
            <div class="col-md-4">
        ...
        <!-- Select Basic -->
        <div class="form-group">
            <label class="col-md-4 control-label" for="salud">Salud</label>
            <div class="col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <textarea class="form-control" id="descripcion" name="descripcion">Introduzca una pequeña descripción del animal</textarea>
            </div>
        </div>
